...
MFbool IntelligenceEngine::RegisterHivemindToEventSpace(HivemindSystemEventSpace& hivemindEventSpace)
{
	hivemind.hivemindSystemEventSpace = &hivemindEventSpace;
	return RegisterObserverToEventSpace(hivemind.hivemindSystemObserver, hivemindEventSpace);
}
