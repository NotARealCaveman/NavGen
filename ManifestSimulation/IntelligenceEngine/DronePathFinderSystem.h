...
{ 	
	...
	public:		
		...
		DronePathFinderSystem(Manifest_Memory::FlatMap<std::vector<ActionDetails>>& droneActions, Manifest_Memory::FlatMap<ArchetypeUpdater>& archetypeUpdaters, Manifest_Memory::FlatMap<DataSystem*>& goalDataSystems, EntityPhysicsData& entityPhysicsData);
