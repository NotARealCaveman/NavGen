...
//**a huge, massive, special thanks to Dr. Eric Lengeyl for yet again coming in clutch with techniques and education for this engine**//
// //================================================================================
//
...
///REGULAR CELLS
// The RegularCellData/ClassData in FGED structure holds information about the triangulation
// used for a single equivalence class in the modified Marching Cubes algorithm,
// described in Section 3.2.
struct RegularCellData
{
	MFu8 geometryCounts;		// High nibble is vertex count, low nibble is triangle count.
	MFu8 vertexIndex[15];	// Groups of 3 indexes giving the triangulation.

	MFlong GetVertexCount(void) const
	{
		return (geometryCounts >> 4);
	}

	MFlong GetTriangleCount(void) const
	{
		return (geometryCounts & 0x0F);
	}
};

// The regularCellClass/Equivalence class in FEGD table maps an 8-bit regular Marching Cubes case index to
...
const MFu8 regularCellClass[256] =
{
...
// The regularCellData/ClassData in FGED table holds the triangulation data for all 16 distinct classes to
...
//FGED 2
const MFu16 vertexCodeTable[256][12] =
{
...
{
	MFlong	geometryCounts;		// High nibble is vertex count, low nibble is triangle count.
	MFu8	vertexIndex[36];	// Groups of 3 indexes giving the triangulation.
